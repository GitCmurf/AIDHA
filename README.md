...
## Quick Start (5-Minute "See It Work" Path)

You can run AIDHA immediately using `npx` to ingest a YouTube video and see the extraction in action:

```bash
# 1. Setup your environment
export YOUTUBE_COOKIE="your-youtube-cookie"
export AIDHA_LLM_API_KEY="your-llm-api-key" # pragma: allowlist secret

# 2. Run the extraction (using npx and tsx)
npx tsx packages/praecis/youtube/src/cli.ts \
  ingest video https://www.youtube.com/watch?v=UepWRYgBpv0
npx tsx packages/praecis/youtube/src/cli.ts \
  extract claims https://www.youtube.com/watch?v=UepWRYgBpv0 --llm
npx tsx packages/praecis/youtube/src/cli.ts \
...
```json
{
  ...
  "@type": "Dataset",
  "name": "AIDHA Knowledge Dossier",
  "claims": [
    {
      "@type": "Claim",
      "text": "Executive function is crucial for organization.",
      "confidence": 0.95,
      "provenance": [
        {
          "@type": "MediaObject",
          "contentUrl": "https://www.youtube.com/watch?v=UepWRYgBpv0",
          "startTime": "PT1M20S"
        }
      ]
    }
