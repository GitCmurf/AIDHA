...
<!-- Numbered list of behaviours observable from the outside. -->

### Non-Functional Requirements
<!-- Performance, reliability, security, data retention, accessibility, etc. -->

### Constraints
<!-- Technical, legal, operational, or ecosystem constraints. -->
...
## Open Questions
<!-- For reviewers: decisions still outstanding or requiring alignment. -->

## Appendix
<!-- Optional: data tables, benchmarking notes, supporting analysis. -->
